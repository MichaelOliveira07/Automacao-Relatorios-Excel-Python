...
💻 Desenvolvi um projeto em Python focado em resolver esse problema. 

---

### A solução realiza:
✅ Extração Inteligente: Busca automática em várias pastas e junta todas as     abas de diferentes arquivos Excel em um só lugar.
